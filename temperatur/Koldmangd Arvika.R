...
FROM dbo.ArvikaA AS rt
WHERE MONTH(rt.Datum) IN (11,12,1,2,3)
ORDER BY rt.Datum"
...
#res_filtered <- subset(res, trimws(Sasong) %in% c("1965/1966","1985/1986", "1986/1987", "2002/2003") | year(Datum) >= 2015)
