...
file = "C:\\temp\\smhi-opendata_2_94180_20201228_144056.csv" #Kristinehamn
...
gg <- ggplot(medelvinter, aes(x=Season, y=koldmangd,label=NULL)) +
  geom_segment( aes(x=Season, xend=Season, y=0, yend=koldmangd, color=mycolor), size=4, alpha=0.9) +
...
#  scale_fill_manual(values = mycolor) +
  ...
  labs(title = title,
       subtitle = paste("Max graddagar per s�song. Median =", round(medianall$koldmangd,digits=1)),
       caption = "Data: SMHI")
